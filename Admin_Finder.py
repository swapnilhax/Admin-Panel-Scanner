...
/~~\|__/|  ||| \|   |  /~~\\__>|___ 
   ...
   .__/\__,/~~\| \|| \||___|  \ 
    ...
    """  + END+BLUE+'Admin Page/Shell Scanner'.format(RED, END).center(69) +
...
#os.system("clear")
print(Fore.GREEN + "[1] Get Website IP")
print("[2] Get Your IP")
print("[3] Find Admin Panel")
print("[4] Find Uploaded Shell in Website")
